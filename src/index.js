...
const App = () => {
  ...
  const [textValueX, setTextValueX] = React.useState(50);
  const [textValueY, setTextValueY] = React.useState(50);
  const [dragging, setDragging] = React.useState(false);
  const[subbuu, setSubbu] = React.useState('abhiram');


  const subbu = () => {
    var newName = prompt('Please enter')
    setSubbu(newName)
  }
  ...
  return (
    ...
    <div>
        <div>
        <div><textarea draggable="true"></textarea></div>
        <Draggable>
          <textarea></textarea>
        </Draggable>
        ...
        />
         <br/>
          ...
          height="42" 
          width="42"
          src="https://i.ya-webdesign.com/images/dotted-border-png-10.png"
          draggable="true"
          onDragStart={e => {
            dragUrl.current = e.target.src;
          }}
        ...
        >
          <Layer >
            ...
            <Text
              ...
              onDragEnd={e => {
                setDragging(false);
                setTextValueX(e.target.x());
                setTextValueY(e.target.y());
              }}
            />
          </Layer>
        </Stage>
